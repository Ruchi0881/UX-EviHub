        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Employees_Certifications_CertificationId",
            ...
            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "EmpId", "CertificationId", "DOB", "DOJ", "DesignationId", "Email", "EmergencyContact", "FirstName", "GenderId", "Id", "Interests", "IsAdmin", "LastName", "ManagerId", "Mobile", "ProjectId" },
                values: new object[,]
                {
                    { 1001, null, new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, "sai.teja@evihub.com", "9876543211", "Sai", 1, 1, "AI, Cricket", true, "Teja", 1, "9876543210", 1 },
                    { 1002, null, new DateTime(1999, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, "anjali.sharma@evihub.com", "9123456790", "Anjali", 1, 2, "Machine Learning, Reading", false, "Sharma", 1, "9123456789", 1 }
                });
